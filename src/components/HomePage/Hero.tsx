        ...
        <>
            <div className="relative flex-grow w-full text-purple-400 flex items-center justify-center">
                ...
                <div className="flex flex-col items-center justify-center text-white z-[1]">
                    <h1 className="uppercase text-5xl font-bold text-shadow">Beyond Horizons</h1>
                    <p className="text-xl max-w-[800px] text-center mt-5 text-shadow">This is a travel and birding blog where I share stories from the trails I walk, the skies I watch, and the wonders I discover along the way.</p>

        ...
        <>
            <div className="relative flex-grow w-full text-purple-400 flex items-center justify-center">
                ...
                <div className="flex flex-col items-center justify-center text-white z-[1]">
                    <h1 className="text-center text-3xl md:text-9xl font-medium font-Atma text-shadow">Hi, I&apos;m Arjun</h1>
                    <p className="px-4 text-xl md:max-w-[800px] text-center mt-5 text-shadow">This is my travel and birding blog where I share stories from the trails I walk, the skies I watch, and the wonders I discover along the way.</p>
